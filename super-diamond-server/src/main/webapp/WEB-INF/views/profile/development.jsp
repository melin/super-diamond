...
<div id="exportModuleWin" style="width:700px" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
				...
				<div class="controls ">
					<c:forEach items="${modules}" var="module">
						<div class="checkbox"  id="module-count">
							<label><input type="checkbox" name="moduleCount" value='<c:out value="${module.MODULE_ID}"/>'>
