...
public class ConfigService {
    ...
    @Transactional
    public Config getExportConfig(long projectId, long moduleId, long configId, String type) {
        ...
        String sql = String.format("SELECT CONFIG_KEY, %s, CONFIG_DESC from CONF_PROJECT_CONFIG where PROJECT_ID=? and MODULE_ID=? and CONFIG_ID=?", valueField);
